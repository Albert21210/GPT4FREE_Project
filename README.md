...
|----------|----------------|
| **Blackbox** | GPT-4o, Claude 3.7 Sonnet, DeepSeek R1/V3, Gemini 2.0 Flash |
| **PollinationsAI** | GPT-4o, GPT-4o Large, DeepSeek R1, Mistral, Llama 3.3 70B |
| **DuckDuckGo** | GPT-4o Mini, Claude 3 Haiku, Llama 3.3 70B |
| **Qwen** | Qwen3 235B, Qwen Max, Qwen2.5 Coder 32B |
| **AnyProvider** | GPT-5 Thinking, Kimi K2, Llama 4 Maverick, Cohere Command A |
| **Yqcloud** | GPT-4 |
